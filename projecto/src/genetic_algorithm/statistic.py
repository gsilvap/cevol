...
def save_statistics_and_create_graphs(time_stamp, runs_bests_1, runs_averages_1, runs_bests_2, runs_averages_2, runs_bests_3, runs_averages_3):
    ...
    draw_graphic(figure_filename,bests_per_generation_1, averages_per_generation_1, bests_per_generation_2, averages_per_generation_2,bests_per_generation_3, averages_per_generation_3)
