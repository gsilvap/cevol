...
def sea(numb_generations,size_pop, size_cromo, gene_domain,prob_mut,prob_cross,selection,recombination,mutation,survivors, fit_func, phenotype,elite,t_size):
...
if __name__ == '__main__':
  ...
  avg_matrix = []
  for i in range(0,10):
      bests,averages = sea(numb_generations, size_pop,size_cromo,gene_domain,0.3,0.7,tournament_selection,one_point_cross,muta_reals,survivors_elitism, fitness_rastrigin,phenotype, 0.02,3)
      best_of_bests = max(bests,best_of_bests)
      avg_matrix.append(averages)
